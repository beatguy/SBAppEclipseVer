/*
 * JS for Beatsforsale generated by Exadel Tiggzi
 *
...
j_117_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'banner': 'j_121',
        'mobiletextarea1': 'j_122',
        'mobileaudio1': 'j_123',
        'mobileaudio2': 'j_124',
        'mobileaudio3': 'j_125',
        'mobilebutton5': 'j_126'
    ...
    // screen onload
    screen_E245_onLoad = j_117_onLoad = function() {
        screen_E245_elementsExtraJS();
        j_117_deviceEvents();
        j_117_windowEvents();
        screen_E245_elementsEvents();
    }
    // screen window events
    screen_E245_windowEvents = j_117_windowEvents = function() {
        $('#j_117').bind('pageshow orientationchange', function() {
            adjustContentHeightWithPadding();
        });
    }
    // device events
    j_117_deviceEvents = function() {
        document.addEventListener("deviceready", function() {});
    }
    // screen elements extra js
    screen_E245_elementsExtraJS = j_117_elementsExtraJS = function() {
        // screen (screen-E245) extra code
    }
    // screen elements handler
    screen_E245_elementsEvents = j_117_elementsEvents = function() {
        $("a :input,a a,a fieldset label").live({
            click: function(event) {
                event.stopPropagation();
            }
        });
        $('#j_120 [name="banner"]').die().live({
            click: function() {
        ...
        $('#j_120 [name="mobilebutton5"]').die().live({
            click: function() {
                if (!$(this).attr('disabled')) {
    ...
    $("#j_117").die("pagebeforeshow").live("pagebeforeshow", function(event, ui) {
        j_117_beforeshow();
    });
    if (runBeforeShow) {
        j_117_beforeshow();
...
$("#j_117").die("pageinit").live("pageinit", function(event, ui) {
    j_117_js();
});